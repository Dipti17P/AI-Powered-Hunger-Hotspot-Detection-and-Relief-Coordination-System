...
| **NGO** | All user access + NGO dashboard + receive email alerts |
| **Admin** | Full access + approve/reject reports + Government dashboard |
...
```bash
# Clone the repo
git clone https://github.com/Dipti17P/AI-Powered-Hunger-Hotspot-Detection-and-Relief-Coordination-System.git
